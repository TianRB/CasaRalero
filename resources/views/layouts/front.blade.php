...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-130050309-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-130050309-1');
</script>
				...
				<div class="menu-secundario">
					<nav>
						<ul>
							...
							<li class="btn-ficha-tecnica"><a href="{{ url('/fichastecnicas') }}" >Catálogos</a></li>
							<li class="ofertas"><a href="{{ asset('promociones') }}" target="_blank">Ofertas</a></li>
						</ul>
					</nav>
					<div class="horario">
